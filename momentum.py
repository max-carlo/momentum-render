...
ChatGPT:
Du:
Das ist der aktuelle Code. Bitte passe ihn so an dass die Tabelle mit den historischen Earnings über die gesamte Breite geht und zusätzlich auch Revenue Zahlen sowieso YoY % des Revenue enthält. Darunter soll dann nebeneinander Revenue YoY und Earnings YoY im Chart dargestellt werden, beides in dem Format wie aktuell die Earnings
